...
const CATEGORIES = [
  ...
  },
  {
    ...
    role: 'You are a marketing strategist who turns product goals into focused campaign prompts.',
    keywords: [
      'marketing',
      'campaign',
      'launch',
    ...
    variables: ['campaign_goal', 'target_audience', 'offer', 'channels'],
    outputFormat: ['Campaign Brief', 'Audience Segments', 'Message Angles', 'Channel Plan', 'Success Metrics'],
    patterns: [EXTRA_PATTERNS.fewShot, EXTRA_PATTERNS.verification],
    constraints: [
      'Separate audience insight from messaging ideas.',
      'Avoid unsupported performance claims.',
      'Include measurable success criteria for the campaign.',
    ],
  },
  {
    id: 'research',
    label: 'Research brief',
    role: 'You are a research analyst who turns broad questions into evidence-based research briefs.',
    keywords: [
      'research',
      'brief',
      'competitor',
    ...
    variables: ['research_question', 'source_material', 'comparison_criteria'],
    outputFormat: ['Research Question', 'Evidence Summary', 'Comparison', 'Gaps', 'Follow-up Questions'],
    patterns: [EXTRA_PATTERNS.grounding, EXTRA_PATTERNS.verification],
    constraints: [
      'Separate evidence from interpretation.',
      'Name missing information or weak sources.',
      'Do not present speculation as confirmed research.',
    ],
  },
  {
    id: 'data-analysis',
    label: 'Data analysis',
    role: 'You are a data analyst who turns datasets into careful, caveated insights.',
    keywords: [
      'data',
      'analysis',
      'analytics',
    ...
    variables: ['dataset_description', 'analysis_goal', 'known_limitations'],
    outputFormat: ['Analysis Plan', 'Key Metrics', 'Findings', 'Caveats', 'Recommended Next Checks'],
    patterns: [EXTRA_PATTERNS.grounding, EXTRA_PATTERNS.verification],
    constraints: [
      'State assumptions about the dataset before interpreting results.',
      'Call out missing fields, sample bias, or data quality concerns.',
  ...
  },
  {
    id: 'legal-review',
    label: 'Legal review',
    role: 'You are a legal review assistant that helps flag issues while avoiding legal advice.',
    keywords: [
      'legal',
      'contract',
      'clause',
    ...
    variables: ['document_excerpt', 'review_goal', 'jurisdiction_or_policy_context'],
    outputFormat: ['Review Scope', 'Risk Flags', 'Questions for Counsel', 'Suggested Revisions', 'Non-advice Disclaimer'],
    patterns: [EXTRA_PATTERNS.grounding, EXTRA_PATTERNS.safety],
    constraints: [
      'Do not provide legal advice or definitive legal conclusions.',
      'Tie every flag to specific text or missing context.',
      'Recommend professional review for high-impact decisions.',
    ],
  },
  {
    id: 'learning',
    label: 'Learning tutor',
    role: 'You are a patient tutor who teaches concepts with examples, practice, and feedback.',
    keywords: [
      'learn',
      'learning',
      'teach',
    ...
    variables: ['topic', 'learner_level', 'practice_goal'],
    outputFormat: ['Learning Goal', 'Concept Explanation', 'Worked Example', 'Practice Plan', 'Feedback Rubric'],
    patterns: [EXTRA_PATTERNS.fewShot, EXTRA_PATTERNS.verification],
    constraints: [
      'Match the learner level before introducing advanced terms.',
      'Use examples before assigning practice.',
      'Include a way to check whether the learner understood the concept.',
    ],
  },
  {
    id: 'product-management',
    label: 'Product management',
    role: 'You are a product manager who turns customer and business input into prioritized product decisions.',
    keywords: [
      'product',
      'roadmap',
      'feature',
    ...
    variables: ['product_goal', 'user_feedback', 'constraints'],
    outputFormat: ['Product Context', 'User Needs', 'Prioritization', 'Trade-offs', 'Next Experiments'],
    patterns: [EXTRA_PATTERNS.grounding, EXTRA_PATTERNS.verification],
    constraints: [
      'Separate user evidence from product assumptions.',
      'Explain prioritization trade-offs clearly.',
      'Include the smallest next experiment or validation step.',
    ],
  },
  {
    id: 'general',
...
function localizeCategoryForLanguage(category, requirement, language) {
  ...
  const copy = profile.categories[category.id];
